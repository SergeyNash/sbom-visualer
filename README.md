...
1. Сгенерируйте SBOM для вашего Node.js проекта
2. Загрузите файл в приложение
3. Проанализируйте зависимости на предмет уязвимостей
4. Проверьте соответствие лицензий требованиям

### Аудит безопасности
1. Загрузите несколько SBOM файлов
2. Используйте фильтры для поиска компонентов с высоким риском
3. Изучите детали уязвимых компонентов
4. Составьте план обновления проблемных зависимостей
...
- [ ] Интеграция с реальными базами данных CVE
- [ ] Экспорт отчетов в PDF/Excel
- [ ] REST API для интеграции с CI/CD
- [ ] Поддержка XML и YAML форматов
- [ ] Командная работа и сохранение анализов
- [ ] Расширенная визуализация для больших проектов
