...
import { Upload, Code, AlertCircle, CheckCircle, X, Settings, FileText, FolderOpen } from 'lucide-react';
          ...
          <div className="p-6">
            ...
            >
              ...
              {loading ? (
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-gray-300">Processing project files...</p>
                </div>
              ) : success ? (
                <div className="flex flex-col items-center gap-3">
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      Upload package manager files and source code
                    </p>
                    <p className="text-blue-400 text-sm mt-1">
                      Supported: package.json, requirements.txt, pom.xml, Cargo.toml, go.mod, composer.json
                    </p>
                  </div>
                  <button
            ...
            <div className="mt-6 p-4 bg-gray-700/50 rounded-lg">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Upload the appropriate package manager files (package.json, requirements.txt, etc.) for automatic detection.
              </p>
            </div>
          </div>
        </div>
